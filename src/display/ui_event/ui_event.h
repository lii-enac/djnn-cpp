...
EVENT(double_click, Spike, parent)
...
EVENT2(left_double_click, Spike, left, double_click)
...
EVENT2(stylus_pen_enter, Spike, stylus_pen, enter)
EVENT2(stylus_pen_leave, Spike, stylus_pen, leave)
EVENT2(stylus_eraser_enter, Spike, stylus_eraser, enter)
EVENT2(stylus_eraser_leave, Spike, stylus_eraser, leave)