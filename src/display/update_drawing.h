...
namespace djnn {
  ...
  private:
    class RedrawAction : public Action {
      public:
        RedrawAction (UpdateDrawing * parent, const djnn::string& name) : Action (parent, name), _ud (parent) { finalize_construction (parent, name); }
    ...
    {
      public:
        UndelayedSpike (UpdateDrawing * parent, const djnn::string& name)  : FatProcess (name), _ud (parent) { set_is_model (true); finalize_construction (parent, name); }
    ...
    {
      public:
        AutoRefreshAction (UpdateDrawing * parent, const djnn::string& name) : Action (parent, name), _ud (parent) {}
