...
DRMConnector::DRMConnector (CoreProcess* parent, const string& name, int id, bool connected)
    : FatProcess (name),
...
DRMDevice::DRMDevice (CoreProcess* parent, const string& name, int fd, int min_width, int max_width, int min_height, int max_height)
