...
void
QtDisplayBackend::add_window (QtWindow* win)
{
    _windows.push_back (win);
}
void
QtDisplayBackend::remove_window (QtWindow* win)
{
    _windows.erase (djnnstl::remove (_windows.begin (), _windows.end (), win), _windows.end ());
}
