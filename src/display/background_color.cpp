...
namespace djnn {
  ...
  BackgroundColor::BackgroundColor (ParentProcess* parent, const std::string& name, int r, int g, int b) :
    FatProcess (name),
  ...
  BackgroundColor::BackgroundColor (ParentProcess* parent, const std::string& name, int v) :
    FatProcess (name),
    _cr (nullptr), _cg (nullptr), _cb (nullptr), _cv (nullptr), _c_rv (nullptr), _c_gv (nullptr), _c_bv (nullptr), _c_vrgb (nullptr),
    _toValue (this, "toValue"),
    _toRGB (this, "toRGB"),
  ...
  FatProcess*
  BackgroundColor::create_GObj_prop (IntPropertyProxy **prop, CouplingWithData **cprop, int *rawp, const std::string& name, int notify_mask)
  {
  ...
  FatChildProcess*
  BackgroundColor::find_child_impl (const std::string& name)
  {
