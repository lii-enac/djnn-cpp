...
void init_binary_couplings (FatProcess& _left, FatProcess& _right, FatProcess& _result, Action& _action, Coupling& _c_left, Coupling& _c_right);
void uninit_binary_couplings (FatProcess* this_, FatProcess& _left, FatProcess& _right, FatProcess& _result, Action& _action, Coupling& _c_left, Coupling& _c_right);
...
class BinaryOperator : public BinaryOperatorCommon // Process
{
  public:
    ...
    void serialize (const string& type) override
    {
        ...
        AbstractSerializer::serializer->cpptype_attribute (string (name_info<BinaryFunction>::left), _left.get_value ());
        AbstractSerializer::serializer->cpptype_attribute (string (name_info<BinaryFunction>::right), _right.get_value ());
...
void init_unary_couplings (FatProcess& _input, FatProcess& _output, Action& _action, Coupling& _coupling);
void uninit_unary_couplings (FatProcess* this_, FatProcess& _input, FatProcess& _output, Action& _action, Coupling& _coupling);
