...
template <>
const char name_info<my_exp<double>>::left[];
template <>
const char name_info<my_exp<double>>::right[];
template <>
const char                                                                          name_info<my_exp<double>>::serialize[];
...
template <>
const char name_info<my_log<double>>::left[];
template <>
const char name_info<my_log<double>>::right[];
template <>
const char                                                                          name_info<my_log<double>>::serialize[];
...
template <>
const char name_info<my_log10<double>>::left[];
template <>
const char name_info<my_log10<double>>::right[];
template <>
const char                                                                          name_info<my_log10<double>>::serialize[];
...
template <>
const char name_info<my_sqrt<double>>::left[];
template <>
const char name_info<my_sqrt<double>>::right[];
template <>
const char                                                                           name_info<my_sqrt<double>>::serialize[];
...
template <>
const char name_info<my_abs<double>>::left[];
template <>
const char name_info<my_abs<double>>::right[];
template <>
const char                                                                          name_info<my_abs<double>>::serialize[];
...
template <>
const char name_info<my_pow<double>>::left[];
template <>
const char name_info<my_pow<double>>::right[];
template <>
const char                                                                                                   name_info<my_pow<double>>::serialize[];
...
template <>
const char name_info<my_min<double>>::left[];
template <>
const char name_info<my_min<double>>::right[];
template <>
const char                                                                                                   name_info<my_min<double>>::serialize[];
...
template <>
const char name_info<my_max<double>>::left[];
template <>
const char name_info<my_max<double>>::right[];
template <>
const char                                                                                                   name_info<my_max<double>>::serialize[];
...
template <>
const char name_info<my_clamp_min<double>>::left[];
template <>
const char name_info<my_clamp_min<double>>::right[];
template <>
const char                                                                                                         name_info<my_clamp_min<double>>::serialize[];
...
template <>
const char name_info<my_clamp_max<double>>::left[];
template <>
const char name_info<my_clamp_max<double>>::right[];
template <>
const char                                                                                                         name_info<my_clamp_max<double>>::serialize[];
