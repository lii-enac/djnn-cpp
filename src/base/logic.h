...
template <>
const char name_info<std::logical_and<bool>>::left[];
template <>
const char name_info<std::logical_and<bool>>::right[];
template <>
const char                                                                                                 name_info<std::logical_and<bool>>::serialize[];
...
template <>
const char name_info<std::logical_or<bool>>::left[];
template <>
const char name_info<std::logical_or<bool>>::right[];
template <>
const char                                                                                                name_info<std::logical_or<bool>>::serialize[];
...
template <>
const char name_info<std::not_equal_to<bool>>::left[];
template <>
const char name_info<std::not_equal_to<bool>>::right[];
template <>
const char                                                                                                  name_info<std::not_equal_to<bool>>::serialize[];
...
template <>
const char name_info<std::logical_not<bool>>::left[];
template <>
const char name_info<std::logical_not<bool>>::right[];
template <>
const char name_info<std::logical_not<bool>>::serialize[];
