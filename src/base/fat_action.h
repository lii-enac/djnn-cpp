...
class FatAction : public FatProcess {
  public:
    FatAction (CoreProcess* parent, const string& n, bool model = false)
        : FatProcess (n, model) { // nope: inheriting sub-Actions may have children
          //FatProcess (n, model) {
        /* note:
...
class FatActionParentMethod : public FatAction {
  public:
    FatActionParentMethod (CoreProcess* parent, const djnnstl::string& name) : FatAction (parent, name) {
