...
template <>
const char name_info<TextCatenatorAction>::left[];
template <>
const char name_info<TextCatenatorAction>::right[];
template <>
const char name_info<TextCatenatorAction>::serialize[];

template <>
const char name_info<TextComparatorAction>::left[];
template <>
const char name_info<TextComparatorAction>::right[];
template <>
const char name_info<TextComparatorAction>::serialize[];

template <>
const char name_info<TextContainerAction>::left[];
template <>
const char name_info<TextContainerAction>::right[];
template <>
