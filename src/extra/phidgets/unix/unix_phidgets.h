...
{
  public:
    PhidgetsMonitor (CoreProcess* parent, const string& n) : FatProcess (n), _handle (nullptr) {}
...
class VoltageInputChannel : public FatProcess
{
  private:
    ...
    {
      public:
        ChangeRateAction (CoreProcess* parent, const string& name) : Action (parent, name) {}
    ...
    {
      public:
        ChangeTriggerAction (CoreProcess* parent, const string& name) : Action (parent, name) {}
