...
ostream_proxy&
cout_ostream::get_proxy ()
{
    return cout_proxy;
}
ostream_proxy&
cerr_ostream::get_proxy ()
{
    return cerr_proxy;
}

void
endl_iomanip::do_manip (ostream& o) const
{
...
ostream&
operator<< (ostream& o, const void* t)
{
    o.get_proxy ().ostream << t;
    return o;
}
...
ostream&
operator<< (ostream& o, const char* t)
{
    o.get_proxy ().ostream << t;
    return o;
}
