...
// instance fields end
  ...
  public:
    // model
    void set_is_model (bool v)        { _bitset = (_bitset & !MODEL_MASK) | (v << MODEL_SHIFT); }
    ...
    // activation state
    void set_activating ()            { _bitset = (_bitset & !ACTIVATION_STATE_MASK) |  ACTIVATION_STATE_ACTIVATING; }
    bool is_activating ()             { return    (_bitset &  ACTIVATION_STATE_MASK) == ACTIVATION_STATE_ACTIVATING; }
    void set_activated ()             { _bitset = (_bitset & !ACTIVATION_STATE_MASK) |  ACTIVATION_STATE_ACTIVATED;  }
    bool is_activated ()              { return    (_bitset &  ACTIVATION_STATE_MASK) == ACTIVATION_STATE_ACTIVATED;  }

    void set_deactivating ()          { _bitset = (_bitset & !ACTIVATION_STATE_MASK) |  ACTIVATION_STATE_DEACTIVATING; }
    bool is_deactivating ()           { return    (_bitset &  ACTIVATION_STATE_MASK) == ACTIVATION_STATE_DEACTIVATING; }
    void set_deactivated ()           { _bitset = (_bitset & !ACTIVATION_STATE_MASK) |  ACTIVATION_STATE_DEACTIVATED;  }
    bool is_deactivated ()            { return    (_bitset &  ACTIVATION_STATE_MASK) == ACTIVATION_STATE_DEACTIVATED;  }
