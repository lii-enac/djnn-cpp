...
namespace djnn {
  ...
  public:
    ...
    virtual void add_child_at (FatProcess *cont, FatChildProcess *c, int neighboor_index, int spec, int new_index) = 0;
    virtual void move_child_to (FatProcess *cont, FatChildProcess *c, int neighboor_index, int spec, int new_index) = 0;
