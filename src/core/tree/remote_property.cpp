...
namespace djnn
{
  ...
  void
  AbstractRemoteProperty::set_value (const std::string& v, bool propagate)
  {
    _send = true;
    get_ref_value() = v;
  ...
  void
  AbstractRemoteProperty::set_incoming_value (const std::string& v, bool propagate)
  {
    _send = false;
    get_ref_value() = v;
    if (is_activable () && propagate) {
  ...
  void
  AbstractRemoteProperty::serialize (const std::string& format) {
