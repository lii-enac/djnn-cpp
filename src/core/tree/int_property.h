...
namespace djnn {
  ...
  public:
    AbstractIntProperty (ParentProcess* parent, const std::string& name, int notify_mask=notify_none) : AbstractProperty (parent, name, notify_mask) { finalize_construction (parent, name); };
  ...
  public:
    IntProperty (ParentProcess* parent, const std::string& name, int v) : AbstractIntProperty (parent, name), value(v) { }
  ...
  public:
    IntPropertyProxy (ParentProcess* parent, const std::string& name, int &v, int notify_mask=notify_none) : AbstractIntProperty (parent, name, notify_mask), value(v) { }
    FatProcess* clone () override;
  protected:
    virtual int& get_ref_value() override { return value; }
    virtual const int& get_ref_value() const override { return value; }
