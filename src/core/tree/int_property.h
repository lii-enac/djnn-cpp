...
namespace djnn {
  ...
  public:
    IntProperty (int v) : AbstractProperty (), value (v) { _type = Integer; };
    IntProperty (Process *p, const string &name, int v) : AbstractProperty (p, name), value (v) { _type = Integer; Process::finalize (); };
