...
namespace djnn
{
  ...
  */
  ...
  void
  JSONSerializer::text_attribute (const std::string& name, const std::string& value){
  ...
  void
  JSONSerializer::int_attribute (const std::string& name, int value){
  ...
  void
  JSONSerializer::float_attribute (const std::string& name, double value){
