...
namespace djnn
{
  ...
  class PhyObj : public Process {
    class D3PhyObjUpdatePosition : public Action {
        public:
          D3PhyObjUpdatePosition (Process *p, const string &n) : Action (p, n) { Process::finalize_construction (); }
        ...
        public:
          D3PhyObjUpdateVelocity (Process *p, const string &n) : Action (p, n) { Process::finalize_construction (); }
