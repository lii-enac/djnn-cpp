...
namespace djnn
{
  AbstractPropSphere::AbstractPropSphere (ParentProcess* parent, const std::string& name, double radius) :
    PhyObj (parent, name),
  ...
  FatChildProcess*
  AbstractPropSphere::find_child_impl (const std::string& name)
  {
