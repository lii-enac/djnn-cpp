...
namespace djnn
{
  AbstractPropBox::AbstractPropBox (ParentProcess* parent, const std::string& name, double w, double h, double d) :
    PhyObj (parent, name),
  ...
  FatChildProcess*
  AbstractPropBox::find_child_impl (const std::string& name)
  {
