...
namespace djnn
{
  Layer::Layer (ParentProcess* parent, const djnn::string& n, double x, double y, double w, double h) :
  ...
  Layer::Layer (ParentProcess* parent, const djnn::string& n) : Layer(parent, n, 0,0,-1,0)
  {
  }
