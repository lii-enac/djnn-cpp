...
namespace djnn
{
  TextField::TextField (ParentProcess* parent, const string& name, CoreProcess* text, CoreProcess* shape) :
  ...
  static int
  sizeof_back_utf8char(const string& str)
  {
    if (str.empty ())
      return 0;
  ...
  static int
  sizeof_front_utf8char(const string& str)
  {
    if (str.empty ())
      return 0;
