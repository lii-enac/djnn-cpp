...
namespace djnn
{
  ...
  coord_t
  next_index (const djnnstl::string &str, coord_t idx)
  {
  ...
  coord_t
  previous_index (const djnnstl::string &str, coord_t idx)
  {
    if (idx <= 0) return 0;
    int offset = 1;
    auto cp = str.data () + idx;
  ...
  bool
  is_starting_word (const djnnstl::string &str, coord_t i)
  {
    if (i <= 0) return true;
    char c = str.at (i);
  ...
  coord_t
  first_word (const djnnstl::string &str, coord_t idx)
  {
  ...
  coord_t
  next_word (const djnnstl::string &str, coord_t idx)
  {
  ...
  coord_t
  previous_word (const djnnstl::string &str, coord_t idx)
  {
