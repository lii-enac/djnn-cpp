...
namespace djnn
{
  AbstractPropEllipse::AbstractPropEllipse (ParentProcess* parent, const djnn::string& name, double cx, double cy, double rx, double ry) :
  ...
  FatChildProcess*
  AbstractPropEllipse::find_child_impl (const djnn::string& name)
  {
