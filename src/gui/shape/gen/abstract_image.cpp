...
namespace djnn
{
  AbstractImage::AbstractImage (ParentProcess* parent, const djnn::string& name, double x, double y, double width, double height) :
  ...
  FatChildProcess*
  AbstractImage::find_child_impl (const djnn::string& name)
  {
  ...
  AbstractImage::get_properties_name () const
  {
