 ...
 *      Ecole Nationale de l'Aviation Civile, France (2024-2026)
...
class AbstractHomography : public AbstractPropHomography {
  ...
  public:
    AbstractHomography (CoreProcess* parent, const string& name, double m11 = 1, double m12 = 0, double m13 = 0, double m14 = 0,
