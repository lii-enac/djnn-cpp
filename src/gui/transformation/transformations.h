...
class ScreenToLocal : public FatProcess
{
  ...
  private:
    ...
    {
      public:
        stl_action (CoreProcess* parent, const string& name, ScreenToLocal* stl) : Action (parent, name), _stl (stl) {}
        virtual ~stl_action () {}
...
class LocalToScreen : public FatProcess
{
  ...
  private:
    ...
    {
      public:
        lts_action (CoreProcess* parent, const string& name, LocalToScreen* lts) : Action (parent, name), _lts (lts) {}
        virtual ~lts_action () {}
        void impl_activate () override;
