...
# lib_cppflags += `pkg-config --cflags pangocairo` -I$(cairo_path) -I$(cairo_path)/cairo -I$(LOCALDIR)/include `pkg-config --cflags pango` -DUSE_GL_ES_VERSION_2_0=1 -Isrc/gui/gl_
...
#         -lpangocairo-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lintl -Wl,-framework -Wl,CoreFoundation -L/Users/conversy/src-ext/SwiftShader/build -lEGL 
