...
static int
Ignore (FatProcess** e, const char* v)
{
    return 0;
}
...
static int
ParsePathClip (FatProcess** e, const char* v)
{
    if (!*e)
        *e = new SVGHolder (nullptr, "SVGHolder");
...
static int
ParseFill (FatProcess** e, const char* v)
{
    unsigned r, g, b;
...
static int
ParseFillRule (FatProcess** e, const char* v)
{
...
static int
ParseOpacity (FatProcess** e, const char* v)
{
    double alpha;
...
static int
ParseFillOpacity (FatProcess** e, const char* v)
{
    double alpha;
...
static int
ParseStrokeOpacity (FatProcess** e, const char* v)
{
    double alpha;
...
static int
ParseStrokeWidth (FatProcess** e, const char* v)
{
    double width;
    char*  end;
...
static int
ParseTransform (FatProcess** e, const char* v)
{
    int                 success = 1;
    int                 ret     = 0;
...
static int
ParseRotate (FatProcess** el, const char* v)
{
    double r, cx, cy;
    char*  vv = (char*)v;
...
static int
ParseScale (FatProcess** el, const char* v)
{
    double sx, sy;
    char*  vv = (char*)v;
...
static int
ParseSkewX (FatProcess** el, const char* v)
{
    double a;
    char*  vv = (char*)v;
...
static int
ParseSkewY (FatProcess** el, const char* v)
{
    double a;
    char*  vv = (char*)v;
    if (!XML_Utils::djn_XMLParseDouble (&a, &vv))
...
static int
ParseTranslate (FatProcess** el, const char* v)
{
    double tx, ty;
    char*  vv = (char*)v;
...
static int
ParseLineJoin (FatProcess** e, const char* v)
{
...
static int
ParseLineCap (FatProcess** e, const char* v)
{
...
static int
ParseMiterLimit (FatProcess** e, const char* v)
{
    int   miterLimit;
    char* end;
...
static int
ParseStrokeDashArray (FatProcess** e, const char* v)
{
    int        i         = 0;
    int        size      = 0;
    int        nbBlocks  = 1;
...
static int
ParseStrokeDashOffset (FatProcess** e, const char* v)
{
    int   offset;
    char* end;
...
static int
ParseStyle (FatProcess** e, const char* v)
{
    ...
    while (v < end) {
        ...
        *colon    = '\0';
        ...
        success &= (h1 && (h1->handle_attr (e, colon + 1))) || (h2 && (h2->handle_attr (e, colon + 1)));
...
static int
ParseTextAnchor (FatProcess** e, const char* v)
{
...
static int
ParseClass (FatProcess** e, const char* v)
{
    djn_GraphicalShapeArgs.classname = string (v);
    return 1;
}
} // namespace djnn
