...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/gperf -L C++ -t -N djn_XMLEllipseAttrsLookup -Z XMLEllipseAttrs_Hash src/gui/XML/XMLEllipseAttrs.gperf  */
...
#line 16 "src/gui/XML/XMLEllipseAttrs.gperf"
...
#line 33 "src/gui/XML/XMLEllipseAttrs.gperf"
...
inline unsigned int
XMLEllipseAttrs_Hash::hash (register const char *str, register unsigned int len)
{
...
djn_XMLAttrHandler *
XMLEllipseAttrs_Hash::djn_XMLEllipseAttrsLookup (register const char *str, register unsigned int len)
{
  static djn_XMLAttrHandler wordlist[] =
    {
      {""}, {""},
#line 37 "src/gui/XML/XMLEllipseAttrs.gperf"
      {"ry", &ParseRy},
      {""},
#line 39 "src/gui/XML/XMLEllipseAttrs.gperf"
      {"cy", &ParseCy},
      {""}, {""},
#line 36 "src/gui/XML/XMLEllipseAttrs.gperf"
      {"rx", &ParseRx},
      {""},
#line 38 "src/gui/XML/XMLEllipseAttrs.gperf"
      {"cx", &ParseCx}
    };
...
#line 40 "src/gui/XML/XMLEllipseAttrs.gperf"
