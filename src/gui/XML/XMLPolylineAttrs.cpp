...
static int
ParsePoints (FatProcess** e, const char* v)
{
    char*  p;
    double x, y;
    char*  vv = (char*)v;

    if (djn_PolyArgs.isPolygon)
        djn_PolyArgs.e = new djnn::Polygon (nullptr, "polygon");
    else
        djn_PolyArgs.e = new djnn::Polyline (nullptr, "polyline");
