...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/gperf -L C++ -t -N djn_XMLLineAttrsLookup -Z XMLLineAttrs_Hash src/gui/XML/XMLLineAttrs.gperf  */
...
#line 17 "src/gui/XML/XMLLineAttrs.gperf"
...
#line 34 "src/gui/XML/XMLLineAttrs.gperf"
...
inline unsigned int
XMLLineAttrs_Hash::hash (register const char *str, register unsigned int len)
{
...
djn_XMLAttrHandler *
XMLLineAttrs_Hash::djn_XMLLineAttrsLookup (register const char *str, register unsigned int len)
{
  static djn_XMLAttrHandler wordlist[] =
    {
      {""}, {""},
#line 40 "src/gui/XML/XMLLineAttrs.gperf"
      {"y2", &ParseY2},
      {""},
#line 38 "src/gui/XML/XMLLineAttrs.gperf"
      {"y1", &ParseY1},
      {""}, {""},
#line 39 "src/gui/XML/XMLLineAttrs.gperf"
      {"x2", &ParseX2},
      {""},
#line 37 "src/gui/XML/XMLLineAttrs.gperf"
      {"x1", &ParseX1}
    };
...
#line 41 "src/gui/XML/XMLLineAttrs.gperf"
