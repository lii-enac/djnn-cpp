...
static int
ParseDx (FatProcess** e, const char* v)
{
    double dx = 0;
...
static int
ParseDy (FatProcess** e, const char* v)
{
    double dy = 0;
...
static int
ParseSimpleText (FatProcess** e, const char* v)
{
...
static int
ParseEncoding (FatProcess** e, const char* v)
{
...
static int
ParseFontFamily (FatProcess** e, const char* v)
{
    if (!*e)
...
static int
ParseFontStyle (FatProcess** e, const char* v)
{
...
static int
ParseFontWeight (FatProcess** e, const char* v)
{
    int          val = 50; // normal
    unsigned int i;
    int          isANumber = 1;
...
static int
ParseFontSize (FatProcess** e, const char* v)
{
    double        sz   = 0;
