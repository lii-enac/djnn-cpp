...
{
  public:
    FillColor (CoreProcess* parent, const string& name, int r, int g, int b) : AbstractColor (parent, name, r, g, b) { finalize_construction (parent, name); }
    FillColor (CoreProcess* parent, const string& name, int v) : AbstractColor (parent, name, v) { finalize_construction (parent, name); }
    virtual ~FillColor () {}
    void       draw () override;
...
{
  public:
    OutlineColor (CoreProcess* parent, const string& name, int r, int g, int b) : AbstractColor (parent, name, r, g, b) { finalize_construction (parent, name); }
    OutlineColor (CoreProcess* parent, const string& name, int v) : AbstractColor (parent, name, v) { finalize_construction (parent, name); }
