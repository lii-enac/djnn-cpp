...
namespace djnn
{
  AbstractPropLinearGradient::AbstractPropLinearGradient (ParentProcess* parent, const std::string& name, double x1, double y1, double x2, double y2, int spread, int coords) :
