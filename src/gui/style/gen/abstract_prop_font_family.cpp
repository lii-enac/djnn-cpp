...
namespace djnn
{
  AbstractPropFontFamily::AbstractPropFontFamily (ParentProcess* parent, const std::string& name, const std::string& family) :
  ...
  FatChildProcess*
  AbstractPropFontFamily::find_child_impl (const std::string& name)
  {
