...
namespace djnn
{
  AbstractPropFontSize::AbstractPropFontSize (ParentProcess* parent, const std::string& name, int unit, double size) :
  ...
  FatChildProcess*
  AbstractPropFontSize::find_child_impl (const std::string& name)
  {
