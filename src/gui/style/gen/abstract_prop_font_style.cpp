...
namespace djnn
{
  AbstractPropFontStyle::AbstractPropFontStyle (ParentProcess* parent, const djnn::string& name, int style) :
  ...
  FatChildProcess*
  AbstractPropFontStyle::find_child_impl (const djnn::string& name)
  {
