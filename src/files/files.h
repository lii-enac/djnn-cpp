...
{
  public:
    File (CoreProcess* parent, const string& name, const string& path, const string& filename, bool is_dir) : FatProcess (name), _path (this, "full_path", path), _filename (this, "filename", filename),
