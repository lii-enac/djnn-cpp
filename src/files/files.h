...
namespace djnn
{
  ...
  private:
    ...
    {
    public:
      FileReaderAction (ParentProcess* parent, const djnn::string& name) : Action (parent, name) {}
      void impl_activate () override;
    };
  public:
    FileReader (ParentProcess* parent, const djnn::string& name, const djnn::string& filename);
    virtual ~FileReader ();
    void impl_activate () override;
  ...
  private:
     ...
     {
     public:
       UpdateAction (ParentProcess *parent, const djnn::string& name) : Action (parent, name) {}
     ...
     {
     public:
       ChangePathAction (ParentProcess *parent, const djnn::string& name) : Action (parent, name) {}
       void impl_activate () override { ((DirectoryObserver*)get_parent ())->change_path (); };
       void impl_deactivate () override {}
     };
  public:
    DirectoryObserver (ParentProcess *parent, const djnn::string& name, const djnn::string& path);
  ...
  {
  public:
    File (ParentProcess *parent, const djnn::string &name, const djnn::string &path, const djnn::string &filename, bool is_dir) :
    ...
    void impl_activate () override {};
    void impl_deactivate () override {}
    const djnn::string& get_filename () { return _filename.get_value(); }
    const djnn::string& get_path () { return _path.get_value(); }
    bool is_dir () { return _is_dir.get_value (); }
  private:
    TextProperty _path, _filename;
    BoolProperty _is_dir;
  };
  DirectoryObserverData* p_init_directory_watcher (const djnn::string& path);
