...
namespace djnn
{
  Oscillator::OscillatorAction::OscillatorAction (FatProcess *parent, const std::string& name, DoubleProperty* m,
  ...
  Oscillator::Oscillator (FatProcess *parent, const std::string& name)
  : FatProcess (name),
  _m (this, "m", 1),
  _k (this, "k", 1),
  ...
  void
  Oscillator::set_parent (FatProcess* p)
  { 
