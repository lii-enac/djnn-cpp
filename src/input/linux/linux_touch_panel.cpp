...
LinuxTouch::LinuxTouch (unsigned int fieldmap)
    : FatProcess ("LinuxTouch")
{
...
LinuxTouchPanel::LinuxTouchPanel (CoreProcess* parent, const string& name, const struct libevdev* dev)
    : LinuxDevice (parent, name, TOUCH_PANEL)
{
