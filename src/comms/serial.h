...
namespace djnn
{
  ...
  private:
    ...
    {
    public:
      SerialOutAction (ParentProcess* parent, const djnn::string& name) :
  ...
  public:
    Serial (ParentProcess* parent, const djnn::string& name,
      const djnn::string& port, int baudrate=9600, char eol='\n');
