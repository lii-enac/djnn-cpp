...
struct mystring {
    ...
    bool      operator!= (const char* op2) const { return !(*this == op2); }
    bool      operator== (const mystring&) const;
    bool      operator!= (const mystring op2) const { return !(*this == op2); }
...
//djnnstl::string  toString (const AbstractSimpleProperty& x); // TODO
//djnnstl::string& toString (CoreProcess* p); // TODO
mystring       getString (djnn::CoreProcess* p);
#define DJNN_C_API_GET_STRING_DEFINED
//void             setString (CoreProcess* p, djnnstl::string& v); // TODO
...
djnn::CoreProcess* djnn_new_ProcessCollector (djnn::CoreProcess* parent, const char* name, int);
djnn::CoreProcess* djnn_new_ZOrder (djnn::CoreProcess* parent, const char* name, int);
djnn::CoreProcess* djnn_new_PreviousDouble (djnn::CoreProcess* parent, const char* name, double);
