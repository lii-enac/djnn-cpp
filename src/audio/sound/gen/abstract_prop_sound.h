...
namespace djnn
{
  ...
  {
  public:
    AbstractPropSound (ParentProcess* parent, const djnn::string& name, double gain, double lowpass_gain, double lowpass_freq, double x, double y, double z, double pitch_mul, int loop);
