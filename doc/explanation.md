...
The deactivation of a process entails the deactivation of its children.

Internally, a process with subprocesses has 2 other states: ACTIVATING, DEACTIVATING.
While activating its children, a process is in the ACTIVATING state. While deactivating its children is in the DEACTIVATING state.

Activating a process is dependent on the state of its parent.
If a process has no parent, it can be activated.
If a process has a parent and the parent is activated or activating, it can be activated.
If a process has a parent and the parent is deactivated or deactivating, it cannot be activated.
...
The sort test was performed after each process activation, to take into account such changes that occured during this activation.
