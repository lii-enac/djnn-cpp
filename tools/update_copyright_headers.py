#!/usr/bin/env python3
"""
Check and update djnn C/C++ source headers.
...
The script scans src/**/*.cpp and src/**/*.h, excluding any path component named
"ext" or "gen". By default it only rewrites recognized djnn headers. Missing
headers are listed; use --insert-missing with --write to add them.
For recognized and inserted headers, missing Git authors are appended to the
contributors list. --contributor can add one more explicit entry.
"""
...
CONTRIBUTOR_RE = re.compile(r"^\s*\*\s{2,}(.+?)\s*$")
...
IGNORED_COMMITS = {
    ...
    "6d459cb9c4c860466fdbf861c0409bf8ef05e7e9",
    "9dde5b6bc5f1eaf81e64ec2f0ca963b549f7e556",
    "356ec2f786f44bb16e7bc2ef4ad3881527bb96f8",
}
...
def is_djnn_header(header: str) -> bool:
    return "djnn v2" in header and "The copyright holders for the contents of this file are:" in header
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check or update djnn source headers.")
    ...
    print_group("Missing djnn header", missing, root)
